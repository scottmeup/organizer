...
def fetch_payload():
    try:
        ...
        return {'profile': 'default', 'generatedAt': datetime.utcnow().isoformat() + 'Z', 'sections': [{'type': 'calendar', 'title': 'Calendar', 'items': [{'time': '09:00', 'title': 'Fallback event'}]}, {'type': 'tasks', 'title': 'Tasks', 'items': [{'state': 'open', 'title': 'Fallback task'}]}]}
