...
def fetch_payload():
    try:
        ...
        return {
            ...
            'sections': [
                {'type': 'calendar', 'title': 'Calendar', 'items': [{'time': '09:00', 'title': 'Fallback event'}]},
                {'type': 'tasks', 'title': 'Tasks', 'items': [{'state': 'open', 'title': 'Fallback task'}]},
                {'type': 'shopping', 'title': 'Shopping', 'items': [{'checked': False, 'title': 'Fallback item'}]},
            ],
        }
